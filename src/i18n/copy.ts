export const copies = {
  ru: {
    ...
    lesson: {
      ...
      finishDone: 'Готово — двигаемся дальше.', finishQuestion: 'Отметить параграф пройденным?',
    ...
    labs: {
      task: 'Задание:', taskDone: 'Выполнено',
      matrixTask: 'подбери матрицу, которая схлопывает квадрат в отрезок, то есть det A = 0.',
      derivativeTask: 'уменьшай h, пока ошибка не станет меньше 0.05.',
      riemannTask: 'добавляй прямоугольники, пока ошибка не станет меньше 0.01.',
      fourierTask: 'набери столько гармоник, чтобы отклонение на плато стало меньше 0.05.',
      deviation: 'Отклонение на плато',
  ...
  en: {
    ...
    lesson: {
      ...
      finishDone: 'Done—keep moving.', finishQuestion: 'Mark this section complete?',
    ...
    labs: {
      ...
      matrixTask: 'find a matrix that collapses the square onto a segment, that is, det A = 0.',
      derivativeTask: 'shrink h until the error drops below 0.05.',
      riemannTask: 'add rectangles until the error drops below 0.01.',
      fourierTask: 'add harmonics until the deviation on the plateau drops below 0.05.',
      deviation: 'Deviation on the plateau',
